...
type HeroProps = {
  isOpenNow: boolean;
  opensAt?: string; // ej. "7:00 AM", solo se usa si isOpenNow es false
  locationLabel: string; // ej. "El Paso, TX"
};

/**
 * Hero — un solo CTA dominante ("Ver menú y precios"), según la
 * corrección de CRO: dos botones del mismo peso generan parálisis
 * de decisión en el momento de mayor tráfico del sitio.
 * "¿Dónde estamos hoy?" queda como enlace secundario, no botón.
 */
